...
object WikiUrlResolver {
    ...
    private val EXPANSION_LIST: Set<String> = setOf(
        ...
        "아기 황소너구리", "아스날 펍", "알바천국", "언더 월드", "엽총과 송곳니", "옛날 옛적에",
    ...
    private val STORY_LIST: Set<String> = setOf(
        ...
        "도봉산의 등산객들", "생명의 다리", "텅 빈 소각장", "누더기 왕의 대관식", "쇼미더힙합", "잔해 속 자장가",
        ...
        "실전! 강력한 직감", "실전! 낚시 실력", "연금술사", "해와 달 용병단", "한강의 참치"
    )
    ...
    private val LEVEL_LIST: Set<String> = setOf(
        "이상한 꿈", "엄마가 된 리트리버", "지뢰나라 왕자님", "헌옷수거함",
        "불꽃놀이 할아버지", "사우나", "무지개 드라이크리닝", "한강 낚시",
        "별똥별", "뒷골목에도 사랑은 핀다", "사격 연습", "운수 좋은 날",
        "초보자 가르치기", "반지하 가족", "미술 경매", "미군 밀매상",
        "방사능 블랙잭", "핵물리학 연구소", "고기 농사", "메인 스토리 : 코마",
        "거대 지렁이"
    )
    ...
    private val TITLE_ALIAS_MAP: Map<String, String> = mapOf(
        ...
        // 코마 관련 (레벨)
        "메인스토리:코마"          to "메인 스토리 : 코마",
        "메인스토리코마"           to "메인 스토리 : 코마",
        // 괴물 관련
        ...
        // 엄마가 좋아, 아빠가 좋아?
        "엄마가좋아,아빠가좋아?"      to "엄마가 좋아, 아빠가 좋아?",
        "엄마가좋아,아빠가"      to "엄마가 좋아, 아빠가 좋아?",
        "엄마가좋아아빠가"      to "엄마가 좋아, 아빠가 좋아?",
        // 황야의 크리스마스
        "황야의크리스마스파티"      to "황야의 크리스마스 파티",
        "뒷골목에도사랑" to "뒷골목에도 사랑은 핀다",
        "지뢰나라" to "지뢰나라 왕자님",
        "무지개" to "무지개 드라이크리닝"
    )
